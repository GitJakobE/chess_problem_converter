...
demos = [
    ...
    Board(name="Toft-00-0002.png", l_edge=31, r_edge=575, r_tilt_angle=0, l_tilt_angle=0, top_line=137,
          nr_of_pieces=19),
    Board(name="Toft-00-0003.png", l_edge=49, r_edge=537, r_tilt_angle=0, l_tilt_angle=0, top_line=114,
          nr_of_pieces=17),
    Board(name="Toft-00-0004.png", l_edge=57, r_edge=539, r_tilt_angle=0, l_tilt_angle=0, top_line=107,
          nr_of_pieces=16),
    Board(name="Toft-00-0005.png", l_edge=51, r_edge=572, r_tilt_angle=0, l_tilt_angle=0, top_line=126,
          nr_of_pieces=22),
    ...
    Board(name="Toft-00-0042.png", l_edge=48, r_edge=556, r_tilt_angle=0, l_tilt_angle=0, top_line=114,
          nr_of_pieces=12),
    Board(name="Toft-00-0270.png", l_edge=62, r_edge=560, r_tilt_angle=0, l_tilt_angle=0, top_line=133,
          nr_of_pieces=18),
    ...
    Board(name="Toft-00-0130.png", l_edge=88, r_edge=488, r_tilt_angle=0, l_tilt_angle=0, top_line=124,
          nr_of_pieces=23),
    Board(name="Toft-00-0066.png", l_edge=91, r_edge=452, r_tilt_angle=0, l_tilt_angle=0, top_line=134,
          nr_of_pieces=18),
